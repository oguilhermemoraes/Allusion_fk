...
import { ColorOperatorType, NumberOperatorType, StringOperatorType } from './data-storage-search';
...
export interface IColorSearchCriteria extends IBaseSearchCriteria {
  /** The fixed color id, e.g. 'blue'. */
  value: string;
