...
const dbConfig: DBVersioningConfig[] = [
  ...
  {
    // Version 9, 8-8-26: Added dominant color palette to file (see #66). Non-indexed,
    // stored inline on the file row; index-free Array<{r,g,b,percentage}> is enough for now.
    version: 9,
    collections: [
      {
        name: 'files',
