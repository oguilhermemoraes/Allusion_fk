...
export const FileViewerMenuItems = ({ file }: { file: ClientFile }) => {
  ...
  return (
    <>
      ...
      <MenuItem onClick={handleCopyImage} text="Copy Image" icon={IconSet.MEDIA} />
      <MenuItem
        onClick={() => uiStore.openRenameFileDialog(file)}
        text="Rename File"
        icon={IconSet.EDIT}
      />
      <MenuItem
...
export const ExternalAppMenuItems = observer(({ file }: { file: ClientFile }) => {
  ...
  return (
    <>
      ...
      />
      <MenuItem
        onClick={() => showItemInFolder(file.absolutePath)}
