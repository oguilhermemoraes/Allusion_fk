...
export const ViewCommand = () => {
  return (
    ...
    >
      ...
      <GridSpacingSliderMenuItem />
      <GridRadiusSliderMenuItem />
      <GridBorderWidthSliderMenuItem />
    </MenuButton>
  );
};
...
export const GridSpacingSliderMenuItem = observer(() => {
  const { uiStore } = useStore();
  return (
    <MenuSliderItem
      value={uiStore.gridGap}
      label="Grid spacing"
      onChange={uiStore.setGridGap}
      id="grid-gap"
...
export const GridRadiusSliderMenuItem = observer(() => {
  const { uiStore } = useStore();
  return (
    <MenuSliderItem
      value={uiStore.gridBorderRadius}
      label="Corner radius"
      onChange={uiStore.setGridBorderRadius}
      id="grid-border-radius"
      options={gridRadiusOptions}
      min={0}
      max={24}
      step={1}
      snap={false}
...
export const GridBorderWidthSliderMenuItem = observer(() => {
  const { uiStore } = useStore();
  return (
    <MenuSliderItem
      value={uiStore.gridBorderWidth}
      label="Border thickness"
      onChange={uiStore.setGridBorderWidth}
      id="grid-border-width"
      options={gridBorderWidthOptions}
      min={0}
      max={8}
      step={1}
      snap={false}
